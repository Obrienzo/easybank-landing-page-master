    ...
    return (
        <section className="bg-VeryLightGray">
            <div className="px-5 py-16 lg:py-24 mx-auto max-w-6xl">
                <h2 className="text-center xl:text-start mb-12 text-3xl text-DarkBlue">Latest Articles</h2>
                <ul className="flex flex-wrap md:grid md:grid-cols-4 justify-center gap-5">
                    {articlesList}
                </ul>
            </div>
        </section>
